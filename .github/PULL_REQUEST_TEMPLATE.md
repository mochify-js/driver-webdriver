...
- [ ] `npm run lint`, `npm run prettier:check`, `npx tsc` and `npm run test:integration` pass locally
- [ ] No unrelated changes

<!-- The integration tests need a Selenium server. CI runs the selenium/standalone-firefox Docker image; see the "Start Selenium Server" step in .github/workflows/build.yml. The README also covers local Selenium, SafariDriver and SauceLabs setups. -->
